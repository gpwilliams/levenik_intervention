...
```{r variety-word-type-exposure-data-plot, fig.cap = "Mean nLEDs for the effect of word type within each variety exposure condition in the vocabulary test. Small dots indicate by-participant means. Large dots and whiskers indicate by-condition means and $\\pm$ 1 $SE$ of the mean."}
...
```{r variety-word-type-exposure-plot, fig.cap = "Joint posterior nLEDs for the effect of word type within variety exposure condition in the vocabulary testing phase. Point ranges show posterior median and $\\pm$ 80% and 90% credible intervals."}
...
```{r variety-word-type-exposure-comparison-plot, fig.cap = "Joint posterior nLEDs for the comparison between each level of word type (contrastive words - non-contrastive words) within each variety exposure condition in the vocabulary testing phase. Point ranges show posterior median and $\\pm$ 80% and 90% credible intervals."}
...
report_posteriors(
  ...
  custom_kable(
    ., 
    caption = "Joint posterior estimates of nLEDs for the effect of word type within variety exposure condition in the vocabulary test.",
    add_footer = FALSE
  )
```
...
```{r variety-word-type-testing-data-plot, fig.cap = "Mean nLEDs for the effect of word type within each task and variety exposure condition in the testing phase. Small dots indicate by-participant means. Large dots and whiskers indicate by-condition means and $\\pm$ 1 $SE$ of the mean."}
...
```{r task-variety-word-type-testing-plot, fig.cap = "Joint posterior nLEDs for the effect of word type within each task and variety exposure condition in the testing phase. Point ranges show posterior median and $\\pm$ 80% and 90% credible intervals."}
...
report_posteriors(
  ...
  custom_kable(
    ., 
    caption = "Joint posterior nLEDs for the effect of word type within each task and variety exposure condition in the testing phase.",
    add_footer = FALSE
  )
```
...
```{r variety-word-familiarity-testing-data-plot, fig.cap = "Mean nLEDs for trained and untrained words within each task and variety exposure condition in the testing phase. Small dots indicate by-participant means. Large dots and whiskers indicate by-condition means and $\\pm$ 1 $SE$ of the mean."}
...
```{r task-variety-novel-testing-plot, fig.cap = "Joint posterior nLEDs for the effect of variety exposure condition within each task for novel words only in the testing phase. Point ranges show posterior median and $\\pm$ 80% and 90% credible intervals."}
...
```{r task-variety-novel-testing-compare-plot, fig.cap = "Joint posterior nLEDs for the comparison between each level of variety exposure condition within each task for novel words only in the testing phase. Point ranges show posterior median and $\\pm$ 80% and 90% credible intervals."}
...
report_posteriors(
  ...
  custom_kable(
    ., 
    caption = "Joint posterior nLEDs for the effect of variety exposure condition within each task for novel words only in the testing phase.",
    add_footer = FALSE
  )
```
...
```{r cov-task-variety-word-type-covariate-plot, fig.cap = "Joint posterior nLEDs for the effect of word type within each task, variety exposure condition, and vocabulary test group based on median performance. Point ranges show posterior median and $\\pm$ 80% and 90% credible intervals."}
knitr::include_graphics(
...
```{r cov-task-variety-novel-covariate-plot, fig.cap = "Joint posterior nLEDs for the effect of variety exposure condition within each task as a measure of mean vocabulary test performance for novel words only. Lines and ribbons show posterior median and $\\pm$ 90% credible intervals. The dotted vertical line indicates the median vocabulary test performance."}
knitr::include_graphics(
...
```{r cov-task-variety-novel-covariate-ms-plot, fig.cap = "Joint posterior nLEDs for the effect of variety exposure condition within each task and vocabulary test group based on median performance for novel words only. Point ranges show posterior median and $\\pm$ 80% and 90% credible intervals."}
knitr::include_graphics(
...
```{r cov-task-variety-novel-covariate-ms-compare-plot, fig.cap = "Joint posterior nLEDs for comparison between each level of variety exposure condition within each task and vocabulary test group based on median performance for novel words only. Point ranges show posterior median and $\\pm$ 80% and 90% credible intervals."}
knitr::include_graphics(
