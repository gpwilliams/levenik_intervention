...
knitr::include_graphics(c(
  plots_dir[str_detect(plots_dir, "testing_cov_median_t_ev_n.png")],
...
- check all plots and analyses are included, including:

    add in task and variety exposure for novel words to testing phase to the report.
    add in variety exposure for novel words to the testing phase to the report.

Plots:

- Update variety exposure names in all other plots (frequentist summaries)