...
We used the Gruffalo and the Gruffalo's child [@Donaldsn1999; @Donaldson2005], translated into various Scots dialects as a baseline for the amount of phonological and lexical variation between language varieties.
...
word_list_data <- readr::read_csv(
  ...
  arrange(testing_word, desc(contrastive_pronunciation)) %>% 
  select(transparent_spelling:contrastive_pronunciation)

kable(
  word_list_data,
  caption = "Word list used in all conditions.", 
  col.names = c("Base Word", "Inconsistent Spelling", "Noncontrastive", "Contrastive"),
