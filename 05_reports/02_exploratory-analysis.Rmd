...
summary(fitted_models[["testing_cov_model"]])
```
...
knitr::include_graphics(plots_dir[str_detect(plots_dir, "testing_cov_etv_n")])
```
...
knitr::include_graphics(plots_dir[str_detect(plots_dir, "testing_cov_etv_n_median")])
```
